...
void CANLoopTest_Init(void){
	...
	CAN_LoopTestFilterInit.FilterIdHigh=0x012<<5;
	CAN_LoopTestFilterInit.FilterIdLow=0x058<<5;
	CAN_LoopTestFilterInit.FilterMaskIdHigh=0<<5;
	CAN_LoopTestFilterInit.FilterMaskIdLow=0x078<<5;
