#include "xianshi.h"
unsigned char ARR1[]={0,10,10,10,10,10,10,10,10};
unsigned char arr[]={0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F,0x00,0x80
										 //0x6f,0x7f,0x07,0x7d,0x6d,0x66,0x4f,0x5b,0x06,0x3f,0x00
	};
void xianshi_0(unsigned char location,unsigned char num){
	ARR1[location]=num;
	//xianshi(location,ARR1[location]);
}
