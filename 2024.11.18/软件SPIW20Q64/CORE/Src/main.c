...
#include "OLED.h"
#include "DELAY.h"
#include "W25Q64SPIruanjian.h"
void SystemClock_Config(void);
uint8_t MID;
uint16_t ID;
uint8_t TxData[]={216,5,74,249};
...
int main(void)
{
	...
	OLED_Init();
	OLED_Clear();
	W25Q64SPIruanjian_Init();
	W25Q64SPIruanjian_ReadID(&MID,&ID);
	OLED_ShowHexNum(0,0,MID,2,16);
	OLED_ShowHexNum(50,0,ID,4,16);
	OLED_UpData();
	W25Q64SPIruanjian_WriteByte(0x000000,TxData,4);
	W25Q64SPIruanjian_ReadByte(0X000000,RxData,4);
	while (1){
