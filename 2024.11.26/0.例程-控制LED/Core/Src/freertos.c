...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(LEDTask1, LEDEntryTask1, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_LEDEntryTask1 */
/**
* @brief Function implementing the LEDTask1 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LEDEntryTask1 */
void LEDEntryTask1(void const * argument)
{
  /* USER CODE BEGIN LEDEntryTask1 */
  /* Infinite loop */
  for(;;)
  {
